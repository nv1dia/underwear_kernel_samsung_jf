...
export PACKAGEDIR=$PARENT_DIR/Kernel_Stuff/Packages_jfltetmo/AOSP_JFELTE_TMO
#Enable FIPS mode
...
make VARIANT_DEFCONFIG=underwear_jf_tmo_defconfig SELINUX_DEFCONFIG=jfselinux_defconfig jf_tmo_defconfig
...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	rm ramdisk.gz
	rm zImage
	rm ../Underwear-kernel-jfltetmo*.zip
	zip -r ../Underwear-kernel-jfltetmo-$curdate.zip .
	cd $KERNELDIR
else
